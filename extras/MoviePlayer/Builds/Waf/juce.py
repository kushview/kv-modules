...
e = xml.etree.ElementTree.parse('../../MoviePlayer.jucer').getroot()
...
@conf
def display_message(self, msg, status = None, color = None):
    color = 'CYAN'
    ...
    Logs.pprint('NORMAL', "%s" % msg.ljust(self.line_just - 3), sep='')
    Logs.pprint('BOLD', ":", sep='')
...
def check_juce (self):
    ...
    display_msg (self, "Checking JUCE Module Path")
